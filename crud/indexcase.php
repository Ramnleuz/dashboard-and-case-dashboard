...
if(isset($_GET['search'])) {
    $search = $_GET['search'];
    $sql = "SELECT * FROM crud WHERE full_name LIKE '%$search%' OR stud_no LIKE '%$search%' OR offense LIKE '%$search%''";
} else {
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="casereport.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
